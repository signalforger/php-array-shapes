...
class GenerateApiDocsCommand extends Command
{
    ...
    protected $description = 'Generate OpenAPI documentation from Action classes using reflection on typed arrays and array shapes';
    ...
    public function handle(): int
    {
        ...
        $this->line('Scanning Action classes for typed return values...');
