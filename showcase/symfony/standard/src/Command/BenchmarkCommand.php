...
#[AsCommand(
    name: 'app:benchmark',
    description: 'Benchmark entity creation and array processing (standard PHP)',
)]
class BenchmarkCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->title('PHP Array Shapes Benchmark - STANDARD PHP');
        $io->text([
        ...
        // Benchmark 2: Transform entities to arrays (chained generators)
        $io->section('Benchmark 2: Transforming entities to API response arrays...');
        $start = hrtime(true);
        $responseCount = 0;
        ...
        // Benchmark 3: Create normalized job arrays
        $io->section('Benchmark 3: Creating normalized job arrays...');
        $start = hrtime(true);
        $normalizedCount = 0;
        ...
        // Benchmark 4: Process arrays (generator consumed inline)
        $io->section('Benchmark 4: Processing and accessing array data...');
        $start = hrtime(true);
        ...
        $io->section('Benchmark 5: Creating nested response structures...');
        $start = hrtime(true);
        $nestedCount = 0;
